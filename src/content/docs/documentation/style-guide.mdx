---
title: Style project
description: Testing the MDX style project with Tailwind Typography
---
...
For more information about how to use the plugin and the analysis it includes, [read the documentation](https://github.com/tailwindcss/typography/blob/master/README.md).
...
With `remark-gfm`, we get a few extra analysis in our markdown. Example: autolink literals.
